...
exports.HelixChatProvider = void 0;
const vscode = require("vscode");
class HelixChatProvider {
    constructor(_extensionUri, backendUrl) {
    ...
    async _handleDroppedFiles(filePaths) {
        const fileUris = filePaths.map(path => vscode.Uri.file(path));
        await this._processFileUris(fileUris);
    }
    async _processFileUris(fileUris) {
    ...
    async _processDirectory(dirUri) {
...
exports.HelixChatProvider = HelixChatProvider;
HelixChatProvider.viewType = 'helixChatView';
