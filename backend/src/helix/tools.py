...
def modernize_code_tool(
    code: str,
    file_path: Optional[str] = None,
    language: Optional[str] = None,
    base_dir: str = "."
) -> Dict[str, Any]:
    """Analyze old code and provide modernization recommendations.
    ...
    try:
        ...
        semantic_analyzer = SemanticAnalyzer(base_dir)
        modernizer = CodeModernizer(web_search, semantic_analyzer)
